      ...
      :key="index" @click="show(character.name,index)">
        ...
        <span class="title">{{character.name}}</span><br>
          <div v-if="isHidden">
            ...
            <p v-else-if="index == 0 && character.name == saveName">
              gender: {{character.gender}}<br>
              birth year: {{character.birth_year}}<br>
              height: {{character.height}}<br>
              mass: {{character.mass}}<br>
